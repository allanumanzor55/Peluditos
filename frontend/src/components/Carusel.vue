        ...
        <b-carousel-slide>
          <template #img>
            <img
              ...
              width="1024"
              height="480"
              src="https://placedog.net/1024/490"
              alt="image slot"
            />
          </template>
        </b-carousel-slide>
      ...
      <div class="container marketing">
        <div>
          <b-card-group columns>
            ...
            <b-card
              img-src="https://placedog.net/500/350?random"
              img-alt="Image"
              img-top
            >
              <b-card-text>
            ...
            <b-card>
              <b-card-title>Adoptalos</b-card-title>
              <b-card-text>
            ...
            <b-card
              img-src="https://placedog.net/350/450"
              img-alt="Image"
              img-fluid
            ></b-card>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-5">
            <b-img
              ...
              width="500"
              height="500"
              src="https://loremflickr.com/500/500/hamster,small"
        ...
        <div class="row featurette">
          ...
          <div class="col-md-5 order-md-1">
            <b-img
              ...
              width="500"
              height="500"
              src="https://loremflickr.com/500/500/hamster,big"
              preserveAspectRatio="xMidYMid slice"
              focusable="false"
              role="img"
              aria-label="Placeholder: 500x500"
