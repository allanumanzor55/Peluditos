      ...
      <v-col class="text-center">
        ...
        <v-form ref="formLogin" v-model="valid" lazy-validation>
          ...
          <div class="text-right mb-3">
            <a class="txtr" @click="showPasswordComponent"
        ...
        <div class="mt-4">
          ...
          <a
            href="/#/registro"
            type="button"
            class="btn colorbtn btn-sm white--text"
            >Registrate</a
          >
        </div>
      </v-col>
          ...
          if (this.login.user === null) {
            ...
            if (!this.login.user.active) {
              this.$swal({
                icon: "info",
                title:
                  "Su perfil ha sido desactivado, espere hasta que un administrador lo desbloquee",
              });
            }
          }
        }
